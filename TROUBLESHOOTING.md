...
- Codex: install supported CLI 0.154.x/0.155.x and Refresh the provider panel. Common user-local/Homebrew paths are searched. ChatGPT sign-in is separate from API keys.
...
Report version, OS, installation type, reproduction and redacted logs at https://github.com/snowopsdev/loqui/issues.
