...
test("a configured OpenAI realtime model streams with its own stored key", async (t) => {
...
test("Gemini streaming requires its live model and own stored key", async (t) => {
  const manager = await loadManager(t);
